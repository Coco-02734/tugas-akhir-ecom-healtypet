...
<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="<?= base_url('admin') ?>"><img src="<?= base_url('assets/klinik/') ?>images/logoa.png" alt="logo" /></a>
        <a class="navbar-brand brand-logo-mini" href="<?= base_url('admin') ?>"><img src="<?= base_url('assets/klinik/') ?>images/logokecil.png" alt="logo" /></a>
    </div>
